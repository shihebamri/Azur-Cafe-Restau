        ...
        <FadeInStagger>
          ...
          <div className="mb-16 grid gap-8 md:grid-cols-3">
            <FadeIn>
              <div className="text-center">
                ...
                <h3 className="text-lg">Service Client</h3>
              </div>
            </FadeIn>
            <FadeIn delay={0.2}>
              <div className="text-center">
                ...
                <h3 className="text-lg">Achetez Nos Spécialités en Ligne</h3>
              </div>
            </FadeIn>
            <FadeIn delay={0.4}>
              <div className="text-center">
                ...
                <h3 className="text-lg">Notre Emplacement</h3>
              </div>
            </FadeIn>
          </div>
            ...
            <FadeIn>
              <div>
                <Link href="/" className="text-2xl font-light text-center block mb-4">
                  Azur Cafe Restaurant
                </Link>
              </div>
            </FadeIn>
            <FadeIn delay={0.2}>
              <div>
                <h4 className="mb-4 text-lg">Liens Utiles</h4>
          ...
          <FadeIn>
            <div className="border-t border-neutral-800 py-8 text-center text-sm text-neutral-400">
              © 2023 Azur Cafe Restaurant. Tous droits réservés.
            </div>
          </FadeIn>
        </FadeInStagger>
      </div>
